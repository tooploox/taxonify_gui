...
QtObject {
    ...
    // type - type of error - see RequestError
        ...
        argList.push(function(res) {
            if(counter === internal.counter) {
                ...
                if(status === 0 && text === null) {
                    return _emitError(RequestError.NetworkError, res)
                }

                // local files
                if(status === 0 && text !== null && body === null) {
                    return _emitError(RequestError.ParseError, res)
                }
                ...
                if(status === 0 && text !== null && body !== null) {
                    ...
                    if(validator(body)) {
                        ...
                        return _emitError(RequestError.ValidationError, res)
                    }
                }
                ...
                if(status !== 0) {
                    ...
                    if(status >= 200 && status < 300) {
                        ...
                        return _emitError(RequestError.HttpStatus, res)
                    }
                }
            }
        })
